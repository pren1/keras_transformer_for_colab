...
def get_model(token_num,
    ...
    encoder_embed_weights = encoder_embed_weights[0]
    decoder_embed_weights = decoder_embed_weights[0]
    ...
    if use_same_embed:
        encoder_embed_layer = decoder_embed_layer = keras.layers.Embedding(
            ...
            embeddings_initializer = tensorflow.keras.initializers.Constant(encoder_embed_weights),
        ...
        decoder_embed_layer = keras.layers.Embedding(
            ...
            output_dim=embed_dim,
            embeddings_initializer = tensorflow.keras.initializers.Constant(decoder_embed_weights),
